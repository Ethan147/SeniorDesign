...
//NOTE: OS.c contains the timer initializations and interrupts handlers.... for now
// filename **********OS.H***********
...
typedef struct tcb* tcbPt;
typedef struct tcb* tcbList;
...
typedef struct state SystemState;

extern SystemState DisplayState;;
...
extern unsigned long OS_RunTime; //running time of system since power on (seconds)

// --------------- OS_AddPeriodicThread ----------------
// Uses Timer1 interrupts to run user task periodically
